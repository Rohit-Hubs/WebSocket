...
//     description: "Learn React, Node, MongoDB full stack development.",
//     price: "99",
//     rating: "4.9",
...
//     instructorCourses: [],
//     learn: ["React", "Node", "MongoDB", "APIs"],
//     content: ["Intro", "Components", "Backend", "Deployment"],
//     requirements: ["HTML", "CSS", "JavaScript"]
//   },

//   {
//     title: "Selenium Automation Testing",
//     description: "Automation testing using Selenium and Java.",
//     price: "79",
//     rating: "4.7",
...
//     instructorCourses: [],
//     learn: ["Selenium", "TestNG", "Automation Framework"],
//     content: ["Selenium Basics", "Automation Scripts"],
...
//     instructorCourses: [],
//     learn: ["Figma", "UI Design", "UX Research"],
//     content: ["Figma Tools", "Wireframes", "Prototype"],
//     requirements: ["Basic Computer Knowledge"]
//   },

//   {
//     title: "Java Full Stack Development",
//     description: "Java, Spring Boot, React full stack.",
//     price: "95",
//     rating: "4.6",
...
//     content: ["Java Basics", "Spring Boot", "Frontend"],
...
//     instructorCourses: [],
//     learn: ["AWS", "Docker", "CI/CD"],
//     content: ["Cloud Basics", "Docker", "Deployment"],
//     requirements: ["Basic Linux"]
//   },
...
//     instructorCourses: [],
//     learn: ["Python", "ML Algorithms"],
//     content: ["Python", "ML Models"],
...
//   if (!course) {
//   return <div className="pt-32 text-center text-2xl">Course Not Found</div>;
// }
...
//             {/* Course Info Box */}
//             <div className="bg-white p-4 rounded-xl shadow mt-6 grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
//               <div>
...
//               <div>
//                 <p className="text-gray-500">Batch Start</p>
//                 <p className="font-semibold">{course.batchStart}</p>
//               </div>
...
//             <div className="bg-white p-6 rounded-xl shadow mt-8">
//               <h2 className="text-xl font-bold mb-4">
//                 More Courses by {course.instructor}
//               </h2>

//               <div className="grid md:grid-cols-3 gap-4">
//                 {course.instructorCourses.map((item, index) => (
...
//                         {item.price}
//                       </p>
//                       <button className="w-full mt-2 py-1 bg-blue-500 text-white rounded">
//                         View Course
//                       </button>
//                     </div>
//                   </div>
...
//                   <span className="font-semibold">{course.batchStart}</span>
//                 </div>
...
//   className="w-full mt-4 py-3 bg-blue-500 text-white rounded-xl font-semibold"
// >
//   Enroll Now
// </button>
...
//                 className="w-full mt-3 py-3 border border-blue-500 text-blue-500 rounded-xl"
//               >
//                 Add to Cart
//               </button>

//               <button className="w-full mt-3 py-3 bg-gray-100 rounded-xl">
//                 Contact Us
//               </button>
//             </div>
//           </div>
...
//               <div key={index} className="bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden cursor-pointer">
//                 <img
//                   src={course.img}
//                   alt={course.title}
...
//                   <button className="w-full mt-3 py-2 bg-blue-500 text-white rounded-lg">
//                     View Course
//                   </button>
//                 </div>
//               </div>
