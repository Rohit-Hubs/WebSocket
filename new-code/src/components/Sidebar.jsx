...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Register User', path: '/tenants', icon: <UserPlus size={22} /> },
    { name: 'Users List', path: '/users', icon: <Users size={22} />, badge: 3 },
  ];
            ...
            {menuItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`flex items-center justify-between p-4 rounded-3xl transition-all duration-300 active:scale-95 ${
                    isActive 
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                to={item.path}
                className={`group relative flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-bold transition-all duration-300 ${
                  isActive 
